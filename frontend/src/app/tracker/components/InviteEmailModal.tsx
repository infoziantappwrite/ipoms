      ...
      <div className="w-full max-w-2xl rounded-2xl bg-surface border border-border shadow-2xl overflow-hidden flex flex-col max-h-[92vh] text-fg">
        ...
        <div className="flex items-center justify-end px-6 py-4 border-t border-border bg-surface-sunken shrink-0">
          <button
            ...
            className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-2 bg-primary hover:bg-blue-700 text-primary-foreground font-bold rounded-xl text-xs shadow-xs transition-all cursor-pointer hover:shadow-md active:scale-[0.992]"
