...
export function ReportsNavigation({ activeTab, onTabChange }: Props) {
  ...
  return (
    <div className="glass-panel border-b border-border px-6 pt-4 pb-0 flex items-center justify-between flex-wrap gap-4">
      <div>
        <div className="flex items-center gap-3">
          <h1 className="text-xl font-bold text-white tracking-tight flex items-center gap-2">
            <TrendingUp size={14} strokeWidth={2} aria-hidden /> Reports & Analytics Center
          </h1>
