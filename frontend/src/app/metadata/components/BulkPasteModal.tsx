...
Amazon	Andy Jassy	9876543211	hr@amazon.com"
            ...
            <div className="flex items-center justify-end pt-3 border-t border-border">
              <button
                ...
                className="w-full sm:w-auto px-6 py-2 bg-primary hover:bg-primary/90 disabled:opacity-40 text-white rounded-lg text-xs font-semibold shadow-xs transition-colors cursor-pointer"
              >
