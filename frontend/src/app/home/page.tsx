  ...
  return (
    <div className="min-h-full flex-1 flex flex-col bg-background text-fg p-4 sm:p-6 lg:p-10 selection:bg-primary selection:text-white">
      <div className="max-w-7xl mx-auto w-full space-y-8 flex-1 flex flex-col justify-between">
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-primary/90 via-indigo-50/40 to-white border border-primary-subtle/80 rounded-3xl p-8 sm:p-10 shadow-1">
          ...
          <div className="relative z-10 max-w-3xl space-y-4">
            ...
            <div className="flex items-center gap-3 pt-3 flex-wrap">
              ...
              <Link
                href="/tracker"
                className="px-6 py-3 bg-white hover:bg-surface-sunken text-fg border border-border-strong rounded-xl font-bold transition-all text-xs flex items-center gap-2 shadow-1"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {modules.map((m, idx) => (
              <Link
                key={idx}
                href={m.href}
                className="group bg-white rounded-2xl border border-border hover:border-primary p-5 flex flex-col justify-between space-y-4 hover:-translate-y-1 transition-all shadow-1 hover:shadow-2"
              >
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <div className={`w-11 h-11 rounded-panel border flex items-center justify-center shadow-1 ${m.color}`}>
        ...
        <div className="bg-white rounded-2xl border border-border p-4 flex items-center justify-between flex-wrap gap-4 text-xs shadow-1">
