      ...
      <div className="relative z-10 max-w-md w-full flex flex-col items-center">
        ...
        <div className="flex items-center gap-3 w-full justify-center flex-wrap">
          <button
            ...
            className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-primary hover:bg-blue-700 text-primary-foreground text-xs font-bold shadow-xs transition-all cursor-pointer hover:shadow-md active:scale-[0.992]"
          >
            <RefreshCw size={15} />
