        ...
        <div className="glass-panel rounded-2xl border border-border p-6 shadow-4 space-y-6">
          <div className="flex items-center justify-between border-b border-border pb-4 flex-wrap gap-3">
            ...
            <a
              ...
              className="px-3.5 py-1.5 rounded-xl bg-[#0078d4] hover:bg-[#006cbd] text-white flex items-center gap-2 text-xs font-semibold shadow-xs transition-transform hover:scale-105 active:scale-[0.992] cursor-pointer"
            >
            ...
            <div className="w-full border-t border-border pt-4 text-left space-y-3 text-xs">
              ...
              <div className="flex items-center justify-between gap-2 text-fg-muted py-0.5">
                ...
                <a
                  ...
                  className="w-7 h-7 rounded-lg bg-[#0078d4] hover:bg-[#006cbd] text-white flex items-center justify-center shadow-xs transition-all hover:scale-105 active:scale-[0.992] cursor-pointer shrink-0 ml-1"
                >
                ...
                {(() => {
                  ...
                  return (
                    <a
                      ...
                      className="w-7 h-7 rounded-lg bg-[#25D366] hover:bg-[#20ba5a] text-white flex items-center justify-center shadow-xs transition-all hover:scale-105 active:scale-[0.992] cursor-pointer shrink-0 ml-1"
                    >
                      <svg className="w-3.5 h-3.5 fill-white" viewBox="0 0 24 24">
              ...
              <div className="flex items-center justify-between text-fg-muted py-0.5">
                ...
                {linkedinProfile ? (
                  <a
                    ...
                    className="w-7 h-7 rounded-lg bg-[#0077b5] hover:bg-[#006097] text-white flex items-center justify-center shadow-xs transition-all hover:scale-105 active:scale-[0.992] cursor-pointer shrink-0 ml-1"
                  >
                    <svg className="w-3.5 h-3.5 fill-white" viewBox="0 0 24 24">
                  ...
                  <a
                    ...
                    rel="noopener noreferrer"
                    title="Open LinkedIn"
                    className="w-7 h-7 rounded-lg bg-[#0077b5]/80 hover:bg-[#0077b5] text-white flex items-center justify-center shadow-xs transition-all hover:scale-105 active:scale-[0.992] cursor-pointer shrink-0 ml-1"
                  >
                    <svg className="w-3.5 h-3.5 fill-white" viewBox="0 0 24 24">
                      <path d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14m-.5 15.5v-5.3a3.26 3.26 0 0 0-3.26-3.26c-.85 0-1.84.52-2.28 1.3v-1.11h-2.79v8.37h2.79v-4.93c0-.77.62-1.4 1.39-1.4a1.4 1.4 0 0 1 1.4 1.4v4.93h2.75M6.46 10.9v8.37H9.2V10.9H6.46M7.83 6.44a1.64 1.64 0 1 0 0 3.28 1.64 1.64 0 0 0 0-3.28z" />
                    </svg>
              ...
              <div className="glass-panel rounded-2xl border border-border p-6 shadow-3 space-y-4">
                ...
                <div className="flex items-center justify-between flex-wrap gap-3 pt-2 border-t border-border">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="px-6 py-3 bg-primary hover:bg-primary/90 text-primary-foreground rounded-xl text-xs font-bold shadow-3 transition-all active:scale-[0.992] disabled:opacity-50 flex items-center gap-2 cursor-pointer"
                  >
                    <Save size={14} />
              ...
              <div className={`glass-panel rounded-2xl border p-6 shadow-3 space-y-4 ${
                ...
                <div className="flex items-center justify-between flex-wrap gap-3 pt-2">
                  ...
                  <button
                    ...
                    className="px-6 py-2.5 bg-primary hover:bg-primary/90 text-primary-foreground rounded-xl text-xs font-bold shadow-2 transition-all active:scale-[0.992] disabled:opacity-50 flex items-center gap-2 cursor-pointer"
                  >
                    <KeyRound size={14} />
          ...
          <div className="max-w-md w-full rounded-3xl bg-white border border-slate-200/90 p-6 shadow-[0_20px_45px_rgba(15,23,42,0.12)] space-y-5">
            ...
            <div className="flex items-center justify-end gap-3 pt-1">
              <button
                ...
                className="px-5 py-2.5 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 hover:text-slate-900 text-xs font-semibold border border-slate-200 transition-all active:scale-[0.992] cursor-pointer"
              >
                Cancel
              </button>
              <button
                ...
                className="px-6 py-2.5 rounded-xl bg-primary hover:bg-primary/90 text-primary-foreground text-xs font-bold shadow-sm transition-all active:scale-[0.992] cursor-pointer"
              >
                OK
              </button>
            </div>
