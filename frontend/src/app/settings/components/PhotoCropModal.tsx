      ...
      <div className="max-w-md w-full rounded-3xl bg-white border border-slate-200/90 p-6 shadow-2xl space-y-5">
        ...
        <div className="flex items-center justify-end gap-3 pt-2">
          ...
          <button
            ...
            className="px-5 py-2 rounded-xl bg-primary hover:bg-primary/90 text-primary-foreground text-xs font-bold shadow-md shadow-primary/25 flex items-center gap-2 transition-all hover:scale-105 active:scale-[0.992] cursor-pointer"
          >
            <Check size={14} />
