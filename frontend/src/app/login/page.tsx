...
type Mode = 'login' | 'forgot' | 'verify_otp' | 'set_new_password';
...
export default function LoginPage() {
  ...
  // Enforce Light Theme: Splash and Login are strictly in Light Theme by default
  useEffect(() => {
            ...
            <form onSubmit={handleLogin} className="space-y-4 text-xs animate-form-in">
              ...
              <div className="pt-3 border-t border-slate-100 text-center">
                <p className="text-micro text-slate-400 leading-relaxed">
                  Coordinator accounts & institutional assignments are provisioned by the Administrator.
                </p>
              </div>
            </form>
          )}
