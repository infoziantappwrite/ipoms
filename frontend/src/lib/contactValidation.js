...
exports.INDIAN_STD_CODES = void 0;
exports.validateAndNormalizeIndianContact = validateAndNormalizeIndianContact;
exports.validateAndNormalizeIndianMobile = validateAndNormalizeIndianMobile;
exports.validateAndNormalizeEmail = validateAndNormalizeEmail;
exports.validateAndNormalizeMultiEmail = validateAndNormalizeMultiEmail;
exports.validateAndNormalizeMultiMobile = validateAndNormalizeMultiMobile;
/**
 * Recognized Indian Landline STD Area Codes & Metro Directories
 */
exports.INDIAN_STD_CODES = {
 ...
 */
function validateAndNormalizeIndianContact(raw) {
    if (!raw || !raw.trim()) {
    ...
    for (const len of [4, 3, 2]) {
        ...
        if (exports.INDIAN_STD_CODES[candidateStd]) {
            matchedStd = candidateStd;
            matchedCity = exports.INDIAN_STD_CODES[candidateStd];
            break;
        }
    }
 ...
 */
function validateAndNormalizeIndianMobile(raw) {
 ...
 */
function validateAndNormalizeEmail(raw) {
    if (!raw || !raw.trim()) {
 ...
 */
function validateAndNormalizeMultiEmail(raw) {
    if (!raw || !raw.trim()) {
 ...
 */
function validateAndNormalizeMultiMobile(raw) {
    if (!raw || !raw.trim()) {
        return { valid: true, normalized: '' };
    }
    const parts = raw
