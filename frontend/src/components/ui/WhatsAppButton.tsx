    ...
    <div className={`relative inline-flex items-center ${className}`} ref={containerRef}>
      <button
        ...
        className="w-5 h-5 rounded-md bg-[#25D366]/15 hover:bg-[#25D366]/30 border border-[#25D366]/40 dark:border-[#25D366]/60
                   text-[#25D366] flex items-center justify-center transition-all hover:scale-110 active:scale-[0.992] cursor-pointer shrink-0 shadow-2xs group/wa"
      >
        ...
        >
          ...
          <div className="flex flex-col gap-1">
            ...
            <button
              ...
              className="flex items-center gap-2.5 px-2.5 py-2 rounded-xl text-left bg-surface-sunken/60 hover:bg-surface-raised border border-border/70 hover:border-primary/40 transition-all active:scale-[0.992] cursor-pointer group"
            >
            ...
            <button
              ...
              className="flex items-center gap-2.5 px-2.5 py-2 rounded-xl text-left bg-surface-sunken/60 hover:bg-surface-raised border border-border/70 hover:border-emerald-500/40 transition-all active:scale-[0.992] cursor-pointer group"
            >
