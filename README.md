...
> **Tech Stack:** Next.js 14+, Node.js (Express.js), MongoDB 7.0+ (Mongoose ODM 8.0+), Tailwind CSS, Nginx  
...
### 📄 Architecture & Database Chapters
...
- 📝 **[Module 01 – User Management](./version%201/module%20md%20files/Module_01_User_Management_Specification_v1.0.md)**
- 📝 **[Module 02 – Master Company Database](./version%201/module%20md%20files/Module_02_Master_Company_Database_Specification_v1.0.md)**
- 📝 **[Module 03 – Daily Tracker](./version%201/module%20md%20files/Module_03_Daily_Tracker_Specification_v1.0.md)**
- 📝 **[Module 04 – Weekly Tracker](./version%201/module%20md%20files/Module_04_Weekly_Tracker_Specification_v1.0.md)**
- 📝 **[Module 05 – Daily Leads](./version%201/module%20md%20files/Module_05_Daily_Leads_Specification_v1.0.md)**
- 📝 **[Module 06 – Reports & Analytics](./version%201/module%20md%20files/Module_06_Reports_Analytics_Specification_v1.0.md)**
- 📝 **[Module 07 – Role-Based Dashboard](./version%201/module%20md%20files/Module_07_Role_Based_Dashboard_Specification_v1.0.md)**
- 📝 **[Module 08 – User Access Management (RBAC)](./version%201/module%20md%20files/Module_08_User_Access_Management_Specification_v1.0.md)**
- 📝 **[Module 09 – Settings & Configuration](./version%201/module%20md%20files/Module_09_Settings_Configuration_Specification_v1.0.md)**
- 📝 **[Module 10 – System Information & Administration](./version%201/module%20md%20files/Module_10_System_Information_Administration_Specification_v1.0.md)**
...
3. **Stateless Dual-Token Authentication:** 8-hour access token (memory-stored) + 7-day refresh token (`HttpOnly`, `SameSite=Strict` secure cookie) with silent Axios refresh interceptor.
