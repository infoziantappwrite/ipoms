...
exports.parseWeeklySheet = parseWeeklySheet;
exports.reloadWeeklyTrackerFrom2027Workbook = reloadWeeklyTrackerFrom2027Workbook;
...
async function reloadWeeklyTrackerFrom2027Workbook(customPath) {
    const possiblePaths = [
        customPath,
    ...
    const deleteResult = await WeeklyTracker_1.WeeklyTracker.deleteMany({});
