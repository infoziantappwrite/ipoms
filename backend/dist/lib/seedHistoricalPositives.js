...
exports.HISTORICAL_POSITIVES_DATA = void 0;
exports.seedHistoricalCallPositives = seedHistoricalCallPositives;
const mongoose_1 = require("mongoose");
const DailyLead_1 = require("../models/DailyLead");
const College_1 = require("../models/College");
const User_1 = require("../models/User");
const CompanyMetadata_1 = require("../models/CompanyMetadata");
exports.HISTORICAL_POSITIVES_DATA = [
    // 7/10/2026
...
async function seedHistoricalCallPositives() {
    try {
        let colleges = await College_1.College.find({ is_deleted: { $ne: true } });
        if (colleges.length === 0) {
            ...
            colleges = await College_1.College.find({ is_deleted: { $ne: true } });
        }
        ...
        let insertedCount = 0;
        for (const item of exports.HISTORICAL_POSITIVES_DATA) {
