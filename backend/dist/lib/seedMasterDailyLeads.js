...
exports.COLLEGE_META_MAP = exports.MASTER_POSITIVES_DATA = void 0;
exports.seedMasterDailyLeads = seedMasterDailyLeads;
const mongoose_1 = require("mongoose");
const DailyLead_1 = require("../models/DailyLead");
const College_1 = require("../models/College");
const User_1 = require("../models/User");
const CompanyMetadata_1 = require("../models/CompanyMetadata");
exports.MASTER_POSITIVES_DATA = [
    // ── 07/07/2026 ─────────────────────────────────────────────────────────────
...
async function seedMasterDailyLeads() {
    try {
        ...
        await DailyLead_1.DailyLead.deleteMany({ lead_type: 'positive' });
        console.log('🗑️  Cleared old DailyLead positives.');
        // 4. Insert master verified positive leads
        const leadsToInsert = [];
        for (const item of exports.MASTER_POSITIVES_DATA) {
