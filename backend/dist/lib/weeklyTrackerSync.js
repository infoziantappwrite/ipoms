...
exports.promoteDailyTrackerRowToWeekly = promoteDailyTrackerRowToWeekly;
 ...
 */
async function promoteDailyTrackerRowToWeekly(dRow, targetYear) {
    if (!dRow.company_name || !dRow.company_name.trim())
        return false;
    const resolvedYear = targetYear ?? (await (0, academicYear_1.getCurrentAcademicYear)());
