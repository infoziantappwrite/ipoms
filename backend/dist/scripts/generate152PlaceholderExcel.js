...
async function generateExcel() {
    ...
    const missingPlaceholders = await CompanyMetadata_1.CompanyMetadata.find(emptyFilter)
    ...
    // Populate data rows
    missingPlaceholders.forEach((comp, idx) => {
    ...
    // Output Paths
    const primaryPath = path_1.default.resolve(__dirname, '../../../152_Missing_Placeholder_Companies.xlsx');
