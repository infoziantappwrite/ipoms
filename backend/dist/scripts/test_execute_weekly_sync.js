...
exports.syncActiveLeadsFromWeeklyTracker = syncActiveLeadsFromWeeklyTracker;
...
async function syncActiveLeadsFromWeeklyTracker() {
    ...
    const finalActiveCount = await ActiveLead_1.ActiveLead.countDocuments({ is_deleted: false });
