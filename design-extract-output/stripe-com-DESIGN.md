...
generated_at: "2026-08-23T12:05:24.169Z"
...
Reading order detected on the source: `cta → nav → nav → nav → pricing-table → hero → pricing-table → content → stats → pricing-table → testimonials → nav → pricing-table → nav → gallery → testimonial → nav → content → pricing-table → pricing-table → gallery → cta → footer`.
...
**Layout primitives:** 52 grid containers · 368 flex containers.
...
|---|---|---|---|
| card | link | md | 182 |
| button | secondary, primary, link | — | 87 |
| other | — | — | 12 |
| link | — | — | 10 |
